    ...
    describe('connections', function () {
          ...
          outputFields: () => ({
            ...
            newTaskEdge: {
              ...
              resolve: (payload, args, context, info) => this.viewerTaskConnection.resolveEdge(
                payload.task, -1, '', args, {...info, orderAttributes: [this.Task.primaryKeyAttribute]}, payload
              )
            }
          }),
      ...
      describe('addEdgeMutation', function () {
        it('should return a appropriate cursor and node', async function () {
          ...
          let result = await graphql({schema: this.schema, source: `
            mutation {
